...
class MonsterInsights_EU_Compliance {
	...
	public function requires_monsterinsights_version() {
		?>
		<div class="error">
			<p><?php esc_html_e( 'Please install or update MonsterInsights Pro version 7.4 or newer to use the MonsterInsights EU Compliance addon', 'monsterinsights-eu-compliance' ); ?></p>
		</div>
		<?php
	}
