 ...
 */
class MonsterInsights_Onboarding_Wizard_Pro {
	...
	public function onboarding_wizard_content() {
		monsterinsights_settings_error_page( 'monsterinsights-vue-onboarding-wizard', '<a href="' . admin_url() . '">' . esc_html__( 'Return to Dashboard', 'ga-premium' ) . '</a>' );
...
new MonsterInsights_Onboarding_Wizard_Pro();
