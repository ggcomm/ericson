			...
			<div class="container">
				<div class="row">
					<div class="col breadcrumbs">
						<a href="<?php echo home_url(); ?>/">Home</a> / <a href="https://store.ericson.com/">Products</a> / <?php echo $page_title; ?>
					</div>
				</div>
			</div>
		</div>
									...
									<?php foreach ($recommmended_products as $recprod_key => $product): ?>
										<div class="col-12 col-sm-6 col-md-4 product-category-block">
											<?php if(isset($product['image'])): ?>
												<div class="row">
													<div class="col">
														<?php if(isset($product['url'])): ?><a href="<?php print $product['url']; ?>"><?php endif; ?><img src="<?php print $product['image']; ?>" class="img-fluid"><?php if(isset($product['url'])): ?></a><?php endif; ?>
													</div>
												</div>
												<div class="row">
